...
```{r, echo = FALSE}
# download DEM
dem_raster_NN_1 <- getData("SRTM", lat = 36.5, lon = -109.5, download = TRUE)
dem_raster_NN_2 <- getData("SRTM", lat = 36.5, lon = -112, download = TRUE)
...
ggplot() +
  ...
  geom_sf(data = huc_10_watersheds, fill = NA, color = "grey64") +
